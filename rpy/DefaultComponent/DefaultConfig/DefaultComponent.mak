...
Car.obj : Car.cpp Car.h    Relationship.h Engine.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Car.obj" "Car.cpp" 



Engine.obj : Engine.cpp Engine.h    Relationship.h Car.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Engine.obj" "Engine.cpp" 



Relationship.obj : Relationship.cpp Relationship.h    Car.h Engine.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Relationship.obj" "Relationship.cpp" 
...
clean:
	...
	if exist Relationship.obj erase Relationship.obj
